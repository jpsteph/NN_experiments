...
for i in range(8):
    err_lst = test_model(scaler, i*25+200, model, sample_profile, prediction_days, plt_errs, err_lst)

sample_profile = make_profile(62, 70, 65, 150)
for i in range(8):
    err_lst = test_model(scaler, i*25+200, model, sample_profile, prediction_days, plt_errs, err_lst)

sample_profile = make_profile(60, 72, 65, 150)
for i in range(8):
    err_lst = test_model(scaler, i*25+550, model, sample_profile, prediction_days, plt_errs, err_lst)

sample_profile = make_profile(60, 68, 65, 150)
for i in range(8):
    err_lst = test_model(scaler, i*25+550, model, sample_profile, prediction_days, plt_errs, err_lst)

sample_profile = make_profile(60, 70, 63, 150)
for i in range(8):
    err_lst = test_model(scaler, i*25+950, model, sample_profile, prediction_days, plt_errs, err_lst)

sample_profile = make_profile(60, 70, 67, 150)
for i in range(8):
    err_lst = test_model(scaler, i*25+950, model, sample_profile, prediction_days, plt_errs, err_lst)
...
while 1:
    ...
    for i in range(int((len(sample_profile)-200)/25)):
        if i!=0:
            err_lst, err_count = test_model(scaler, int(25*i+200), model, sample_profile, prediction_days, True, err_lst, err_count)
            cycle_count+=1
